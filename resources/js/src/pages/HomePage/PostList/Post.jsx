    ...
    render() {
        const iconMenu = (
            ...
            >
                ...
                <MenuItem
                    primaryText={<span>Mute @{this.props.post.address}</span>}
                />
                <MenuItem
                    primaryText={<span>Block @{this.props.post.address}</span>}
                />
        ...
        return (
            <div className="row">
                <Card className="post-card animated fadeInUp">
                    ...
                    <CardActions>
                        <FlatButton
                            label={this.props.post.comments}
                            icon={<IconComment />}
                        />
                        <FlatButton
                            label={this.props.post.repost}
                            icon={<IconRepeat />}
                        />
                        <FlatButton
                            label={this.props.post.favorites}
                            icon={<IconFavorite />}
                        />
